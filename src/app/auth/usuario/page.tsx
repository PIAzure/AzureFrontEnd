                ...
                <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
                    <div className="mx-auto max-w-lg">
                        ...
                        <p className="mt-4 text-gray-500 max-w-[450px]">
                            ...
                            Faça o login para descobrir, participar e se voluntariar nos eventos que mais combinam com seus interesses. Envolva-se em experiências enriquecedoras organizadas por especialistas e entusiastas de diversas áreas.
                        </p>
                    </div>
                    ...
                    <form action="#" className="mx-auto mb-0 mt-8 max-w-lg space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            <p className="text-sm text-gray-500">
                                Não tem conta?{' '}
                                <a className="underline hover:text-cian" href="/auth/usuario/criar-conta">Cadastre-se</a>
                            </p>
